...
pebas_df = pebas_df.loc[pebas_df["city"] == "Parauapebas"]
pebas_df = pebas_df.loc[pebas_df["state"] == "PA"]

pebas_df_full = df_full.loc[df_full["place_type"] == "city"]
pebas_df_full = pebas_df_full.loc[pebas_df_full["state"] == "PA"]
pebas_df_full = pebas_df_full.loc[pebas_df_full["city"] == "Parauapebas"]
